...
export default function EventDetailPage() {
    ...
    const organizerName = (event.organizer?.displayName || event.organizer?.name) ?? '';
            ...
            <div className="mt-6 overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--bg-card)]">
                ...
                <div className="p-6">
                    <div className="flex flex-col gap-4">
                        ...
                        {event.organizer && (
                            <div className="mt-2 flex items-center justify-between gap-4 rounded-lg border border-[var(--border)] bg-[var(--bg-secondary)] px-4 py-3">
                                <UserAvatar
                                    user={{
                                ...
                                >
                                    {t('viewOrganizerProfile', { name: organizerName })}
                                </Link>
                            </div>
                        )}
            ...
            <section className="mt-8">
                ...
                {loadingTickets ? (
                    <div className="mt-4 space-y-3">
                        {[1, 2, 3].map((i) => (
                            <div
                                key={i}
                                className="h-20 animate-pulse rounded-lg bg-[var(--bg-card)]"
                            />
                        ))}
                    </div>
                ...
                {totalSelected > 0 && (
                    <div className="mt-6 rounded-xl border border-[var(--border)] bg-[var(--bg-card)] p-4">
                        ...
                        <p className="text-[var(--text-secondary)]">
                            {totalSelected} {t('ticket', { count: totalSelected })} ·{' '}
                            {t('total')}:{' '}
